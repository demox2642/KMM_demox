object Dependencies {
    ...
    object Image {
        ...
        object Kamel {
            ...
            const val kamel = "com.alialbaali.kamel:kamel-image:$version"
        }
    }
    ...
    object Ktor {
        ...
        const val server_netty = "io.ktor:ktor-server-netty:$version"
        const val server_negotiation = "io.ktor:ktor-server-content-negotiation:$version"
    ...
    object Postgresql{
        ...
        const val sql = "org.postgresql:postgresql:$version"
    }
